// Script to update Calendly webhook subscription URL
...
async function updateWebhook() {
  try {
    ...
    console.log('📋 Step 2: Listing existing webhooks...\n');
    ...
    if (webhooks.length === 0) {
      console.log('⚠️  No existing webhooks found. Creating a new one...\n');
      ...
      console.log(`   Subscription URI: ${createResponse.resource.uri}`);
      console.log(`   Callback URL: ${createResponse.resource.callback_url}`);
      return;
    }
    ...
    for (const webhook of webhooks) {
      ...
      console.log(`🗑️  Deleting old webhook: ${webhookId} (${webhook.callback_url})`);
    ...
    console.log(`   Webhook URL: ${NEW_WEBHOOK_URL}\n`);
